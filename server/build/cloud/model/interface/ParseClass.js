 ...
 *
 */
var ParseClass = (_dec = _flowRuntime2.default.annotate(_flowRuntime2.default.class('ParseClass', _flowRuntime2.default.method('constructor', _flowRuntime2.default.param('className', _flowRuntime2.default.string()), _flowRuntime2.default.param('parameter', _flowRuntime2.default.union(_flowRuntime2.default.string(), _flowRuntime2.default.ref(ParseClass))), _flowRuntime2.default.return(_flowRuntime2.default.ref(Promise))), _flowRuntime2.default.method('validateIdField', _flowRuntime2.default.param('fieldName', _flowRuntime2.default.string()), _flowRuntime2.default.param('className', _flowRuntime2.default.string()), _flowRuntime2.default.return(_flowRuntime2.default.ref(Promise))), _flowRuntime2.default.method('validateIsEdited', _flowRuntime2.default.param('fieldName', _flowRuntime2.default.string()), _flowRuntime2.default.param('className', _flowRuntime2.default.string()), _flowRuntime2.default.return(_flowRuntime2.default.ref(Promise))), _flowRuntime2.default.extends(Parse.Object))), _dec(_class = function (_Parse$Object) {
 ...
 */
	function ParseClass(className, parameter) {
		...
		var _parameterType = _flowRuntime2.default.union(_flowRuntime2.default.string(), _flowRuntime2.default.ref(ParseClass));
		...
		if (validate.isString(parameter)) {
			...
			return _ret = _returnType.assert(_this.constructorFromJsonString(parameter)), _possibleConstructorReturn(_this, _ret);
		} else if (parameter.constructor.name === Parse.Object.className) {
			var _ret2;

			// generate instance from a given Parse Object
			return _ret2 = _returnType.assert(_this.constructorFromParseObject(parameter)), _possibleConstructorReturn(_this, _ret2);
		}
		return _this;
	}
	...
	_createClass(ParseClass, [{
		...
		value: function validateIdField(fieldName, className) {
			...
			return _returnType2.assert(new Promise(function (fulfill, reject) {
				...
				var id = _this2.getObject()[fieldName];
		...
		value: function validateIsEdited(fieldName, className) {
			...
			return _returnType3.assert(new Promise(function (fulfill, reject) {
				...
				var isEdited = _this3.getObject()[fieldName];
