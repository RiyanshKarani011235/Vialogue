...
const CLASS_NAME = ParseClass.imageConfig.CLASS_NAME;
console.log(CLASS_NAME);
const ID_FIELD = ParseClass.imageConfig.ID_FIELD;
console.log("image field'):");
console.log(ID_FIELD);
const TYPE_FIELD = ParseClass.imageConfig.TYPE_FIELD;
console.log(TYPE_FIELD);
const URL_FIELD = ParseClass.imageConfig.URL_FIELD;
console.log(URL_FIELD);
const IS_EDITED_FIELD = ParseClass.imageConfig.IS_EDITED_FIELD;
...
class Image extends Resource {
    ...
    constructor(parameter: string | Resource): Promise {
        return super(ParseClass.imageConfig.CLASS_NAME, parameter);
    }
